...
export function AchievementForm({ resume }: { resume: Resume }) {
  const { addAchievement, updateAchievement, deleteAchievement, updateResume } =
    useResume();
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        deleteAchievement(resume.id, achievement.id);
                      }}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="md:col-span-2">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateAchievement(resume.id, achievement.id, {
