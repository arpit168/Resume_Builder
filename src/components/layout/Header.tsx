    ...
    <header className="sticky top-0 z-50 w-full bg-[#F8FAFC]/80 dark:bg-[#0B0F19]/80 backdrop-blur-md print:hidden border-b border-gray-200/50 dark:border-gray-800/50">
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/dashboard"
            className="hidden sm:flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded-full font-medium text-sm transition-colors shadow-[0_0_15px_rgba(59,130,246,0.3)]"
          >
            Dashboard
            <svg
              width="16"
